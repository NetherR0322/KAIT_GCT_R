...
public class asiMover : MonoBehaviour
{
    ...
    void Update() {
        if (cur.name == "-1") curNameI = -1;
        if (cur.name == "0") curNameI = 0;
        if (cur.name == "1") curNameI = 1;
        if (cur.name == "2") curNameI = 2;
        if (cur.name == "3") curNameI = 3;
        if (cur.name == "4") curNameI = 4;
        if (cur.name == "5") curNameI = 5;
        if (cur.name == "6") curNameI = 6;
        if (cur.name == "7") curNameI = 7;
